...
export default function AboutPage() {
    return (
        <main className="min-h-screen">
            {/* HERO SECTION */}
            <Section variant="contrast" padding="none" className="pt-32 pb-20 relative overflow-hidden">
                ...
                <div className="container relative z-10 text-center">
                    ...
                    <p className="text-xl text-text-inverse/60 max-w-[720px] mx-auto leading-relaxed">
                ...
                <div className="container">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="relative">
                            <div className="aspect-[4/5] bg-bg-soft rounded-[3rem] overflow-hidden shadow-2xl">
                                <img
                            ...
                            <div className="absolute -bottom-10 -right-10 bg-[var(--color-accent)] p-8 rounded-3xl shadow-xl hidden md:block">
                                <div className="text-4xl font-black text-bg-contrast mb-1 italic">10+</div>
                                <div className="text-xs font-bold uppercase tracking-widest text-bg-contrast/60">Years of Experience</div>
                            </div>
                        </div>
                        <div>
                            <h2 className="text-3xl md:text-5xl font-bold mb-8 font-heading italic text-text-primary">{CONFIG.brandName} Philosophy</h2>
                            <div className="space-y-6 text-lg text-text-secondary leading-relaxed">
                                ...
                                <div className="pt-6 grid grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        <div className="text-3xl font-bold text-text-primary mb-2">5,000+</div>
            ...
            <Section variant="soft">
                <div className="container">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6 font-heading text-text-primary">Our Leadership</h2>
                        <p className="text-text-muted max-w-[600px] mx-auto text-lg leading-relaxed">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-w-[900px] mx-auto">
                        {/* CEO */}
                        <div className="bg-bg-surface p-10 rounded-[2.5rem] shadow-premium text-center border border-border-soft group hover:-translate-y-2 transition-all duration-500">
                            <div className="w-32 h-32 rounded-full mx-auto mb-8 bg-bg-soft overflow-hidden ring-4 ring-[var(--color-accent)] ring-offset-4 shadow-xl">
                            ...
                            <h3 className="text-2xl font-bold mb-2 font-heading text-text-primary">{CONFIG.leadership.ceo}</h3>
                            <p className="text-xs font-bold text-[var(--color-accent)] uppercase tracking-widest mb-6">CEO & Founder</p>
                            <div className="w-12 h-1 bg-bg-soft mx-auto rounded-full group-hover:bg-[var(--color-accent)] transition-all"></div>
                        </div>
                        ...
                        <div className="bg-bg-surface p-10 rounded-[2.5rem] shadow-premium text-center border border-border-soft group hover:-translate-y-2 transition-all duration-500">
                            ...
                            <h3 className="text-2xl font-bold mb-2 font-heading text-text-primary">{CONFIG.leadership.md}</h3>
                ...
                <div className="container">
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-10 rounded-[2rem] bg-bg-base border border-border-soft flex flex-col items-center text-center">
                                <div className="w-16 h-16 rounded-2xl bg-bg-contrast text-text-inverse flex items-center justify-center text-2xl mb-8">
                                    <i className={`fa-solid ${v.icon} text-[var(--color-accent)]`}></i>
                                </div>
                                <h4 className="text-xl font-bold mb-4 font-heading text-text-primary">{v.title}</h4>
