        ...
        <main className="min-h-screen">
            ...
            <Section variant="surface">
                <div className="container text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6 font-heading text-text-primary">Why Re-applying Fast is a Mistake</h2>
                    <p className="text-text-secondary max-w-[720px] mx-auto text-lg leading-relaxed">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="p-10 rounded-2xl bg-red-50 border border-red-100">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-text-primary">Lack of New Evidence</h4>
                    ...
                    <div className="p-10 rounded-2xl bg-red-50 border border-red-100">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-text-primary">Inconsistent Info</h4>
                    ...
                    <div className="p-10 rounded-2xl bg-red-50 border border-red-100">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-text-primary">Urgent Filing</h4>
            ...
            {/* 3. RECOVERY STRATEGY */}
            <Section variant="soft" id="strategy">
                <div className="container">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl md:text-5xl font-bold mb-8 font-heading text-text-primary">Our Recovery Protocol</h2>
                            ...
                            <ul className="space-y-6">
                                {[
                                    ...
                                    <li key={idx} className="flex items-start gap-4">
                                        <div className="w-8 h-8 rounded-full bg-bg-contrast text-text-inverse flex items-center justify-center shrink-0 mt-1 font-bold text-xs">
                                            {idx + 1}
                                        </div>
                                        <div>
                        ...
                        <div className="relative">
                            <div className="aspect-square bg-bg-contrast rounded-[3rem] p-12 text-text-inverse flex flex-col justify-center shadow-2xl">
                                <h3 className="text-3xl font-bold mb-6 text-[var(--color-accent)]">95% Success in Recovery</h3>
                                <p className="text-text-inverse/70 text-lg mb-8 italic">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-2xl bg-bg-base border border-border-soft flex flex-col items-center text-center">
                                ...
                                <h4 className="text-lg font-bold mb-2 text-text-primary">{item.case}</h4>
                                <div className="text-xs text-text-muted mb-4 uppercase tracking-widest">Initial Reason: {item.reason}</div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-6">
                                <a href={`https://wa.me/${CONFIG.whatsapp}`} className="flex items-center gap-6 group">
                                    ...
                                    <div>
                                        <div className="text-text-inverse/40 text-xs font-bold uppercase tracking-widest">WhatsApp Specialist</div>
                                ...
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-4 max-w-[450px]">
                                    ...
                                    <div>
                                        <div className="text-sm font-bold text-text-inverse">Confidential Review</div>
                                        <div className="text-xs text-text-inverse/50">Your refusal details are handled with strict privacy.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
